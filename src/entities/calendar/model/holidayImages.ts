...
/** Bundled IDN Nyepi + Idul Fitri cluster image (reused when those dates move). */
const idNyepiEidFitrMarchClusterImage = require('../../../../assets/days_img/id_18-24march.webp');
/** IDN Vesak / Waisak image (reused when the date moves). */
const idMay31WaisakImage = require('../../../../assets/days_img/id_31may.webp');
/** IDN Eid al-Adha image (reused when the date moves). */
const idMay27IdulAdhaImage = require('../../../../assets/days_img/id_27may.webp');
/** IDN collective leave for Eid al-Adha image (reused when SKB adds that day). */
...
const countrySpecificHolidayImageByKey: Record<string, ImageSourcePropType> = {
  ...
  // 1 мая — may1.webp по bundled JSON (RU/TR/ID; JP без праздника 01.05).
  ...
  '2027-01-01|Новый год': newYearImage,
  '2027-01-01|New Year\'s Day': newYearImage,
  '2027-01-01|元日': newYearImage,
  '2027-01-01|Yılbaşı Tatili': newYearImage,
  '2027-01-01|Tahun Baru Masehi': newYearImage,
  '2027-01-02|Новогодние каникулы': newYearImage,
  '2027-01-03|Новогодние каникулы': newYearImage,
  '2027-01-04|Новогодние каникулы': newYearImage,
  '2027-01-05|Новогодние каникулы': newYearImage,
  '2027-01-06|Новогодние каникулы': newYearImage,
  '2027-01-07|Рождество Христово': christmasImage,
  '2027-01-08|Новогодние каникулы': newYearImage,
  '2027-01-11|Coming of Age Day': jpComingOfAgeDayImage,
  '2027-01-11|成人の日': jpComingOfAgeDayImage,
  '2027-02-11|National Foundation Day': jpNationalFoundationImage,
  '2027-02-11|建国記念の日': jpNationalFoundationImage,
  '2027-02-22|Day off for 20 February': defenderDayImage,
  '2027-02-22|Выходной за 20 февраля': defenderDayImage,
  '2027-02-23|Defender of the Fatherland Day': defenderDayImage,
  '2027-02-23|День защитника Отечества': defenderDayImage,
  '2027-02-23|Emperor\'s Birthday': jpEmperorBirthdayImage,
  '2027-02-23|天皇誕生日': jpEmperorBirthdayImage,
  '2027-03-08|International Women\'s Day': march8Image,
  '2027-03-08|Международный женский день': march8Image,
  '2027-03-09|Eid al-Fitr (1st day)': trMarchImage,
  '2027-03-09|Ramazan Bayramı (1. Gün)': trMarchImage,
  '2027-03-09|Day of Silence, Saka New Year': idNyepiEidFitrMarchClusterImage,
  '2027-03-09|Hari Suci Nyepi Tahun Baru Saka 1949': idNyepiEidFitrMarchClusterImage,
  '2027-03-10|Eid al-Fitr (2nd day)': trMarchImage,
  '2027-03-10|Ramazan Bayramı (2. Gün)': trMarchImage,
  '2027-03-10|Eid al-Fitr 1448 H (Day 1)': idNyepiEidFitrMarchClusterImage,
  '2027-03-10|Hari Raya Idul Fitri 1448 H (Hari 1)': idNyepiEidFitrMarchClusterImage,
  '2027-03-11|Eid al-Fitr (3rd day)': trMarchImage,
  '2027-03-11|Ramazan Bayramı (3. Gün)': trMarchImage,
  '2027-03-11|Eid al-Fitr 1448 H (Day 2)': idNyepiEidFitrMarchClusterImage,
  '2027-03-11|Hari Raya Idul Fitri 1448 H (Hari 2)': idNyepiEidFitrMarchClusterImage,
  '2027-03-21|Vernal Equinox Day': jpVernalEquinoxImage,
  '2027-03-21|春分の日': jpVernalEquinoxImage,
  '2027-03-22|Compensatory Holiday': jpVernalEquinoxImage,
  '2027-03-22|振替休日': jpVernalEquinoxImage,
  '2027-03-26|Good Friday': require('../../../../assets/days_img/id_3apr.webp'),
  '2027-03-26|Wafat Isa Al Masih': require('../../../../assets/days_img/id_3apr.webp'),
  '2027-03-28|Easter Sunday': require('../../../../assets/days_img/id_5apr.webp'),
  '2027-03-28|Paskah': require('../../../../assets/days_img/id_5apr.webp'),
  '2027-04-23|National Sovereignty and Children\'s Day': trApril23Image,
  '2027-04-23|Ulusal Egemenlik ve Çocuk Bayramı': trApril23Image,
  '2027-04-29|Shōwa Day': require('../../../../assets/days_img/jp_29apr.webp'),
  '2027-04-29|昭和の日': require('../../../../assets/days_img/jp_29apr.webp'),
  '2027-05-01|Spring and Labor Day': may1Image,
  '2027-05-01|Праздник Весны и Труда': may1Image,
  '2027-05-01|Labour and Solidarity Day': may1Image,
  '2027-05-01|Emek ve Dayanışma Günü': may1Image,
  '2027-05-01|International Workers\' Day': may1Image,
  '2027-05-01|Hari Buruh Internasional': may1Image,
  '2027-05-03|Constitution Memorial Day': require('../../../../assets/days_img/jp_3may.webp'),
  '2027-05-03|憲法記念日': require('../../../../assets/days_img/jp_3may.webp'),
  '2027-05-03|Day off for Spring and Labor Day': may1Image,
  '2027-05-03|Выходной за Праздник Весны и Труда': may1Image,
  '2027-05-04|Greenery Day': require('../../../../assets/days_img/jp_4may.webp'),
  '2027-05-04|みどりの日': require('../../../../assets/days_img/jp_4may.webp'),
  '2027-05-05|Children\'s Day': require('../../../../assets/days_img/jp_5may.webp'),
  '2027-05-05|こどもの日': require('../../../../assets/days_img/jp_5may.webp'),
  '2027-05-06|Ascension of Jesus Christ': require('../../../../assets/days_img/id_14may.webp'),
  '2027-05-06|Kenaikan Isa Al Masih': require('../../../../assets/days_img/id_14may.webp'),
  '2027-05-09|Victory Day': ruMay9Image,
  '2027-05-09|День Победы': ruMay9Image,
  '2027-05-10|Day off for Victory Day': ruMay9Image,
  '2027-05-10|Выходной за День Победы': ruMay9Image,
  '2027-05-16|Eid al-Adha (1st day)': trKbImage,
  '2027-05-16|Kurban Bayramı (1. Gün)': trKbImage,
  '2027-05-16|Eid al-Adha 1448 H': idMay27IdulAdhaImage,
  '2027-05-16|Hari Raya Idul Adha 1448 H': idMay27IdulAdhaImage,
  '2027-05-17|Eid al-Adha (2nd day)': trKbImage,
  '2027-05-17|Kurban Bayramı (2. Gün)': trKbImage,
  '2027-05-18|Eid al-Adha (3rd day)': trKbImage,
  '2027-05-18|Kurban Bayramı (3. Gün)': trKbImage,
  '2027-05-19|Commemoration of Atatürk, Youth and Sports Day': trMay19Image,
  '2027-05-19|Atatürk\'ü Anma, Gençlik ve Spor Bayramı': trMay19Image,
  '2027-05-20|Vesak Day 2571 BE': idMay31WaisakImage,
  '2027-05-20|Hari Raya Waisak 2571 BE': idMay31WaisakImage,
  '2027-06-01|Pancasila Day': require('../../../../assets/days_img/id_1jun.webp'),
  '2027-06-01|Hari Lahir Pancasila': require('../../../../assets/days_img/id_1jun.webp'),
  '2027-06-06|Islamic New Year 1449 H': require('../../../../assets/days_img/id_16jun.webp'),
  '2027-06-06|Tahun Baru Islam 1449 H': require('../../../../assets/days_img/id_16jun.webp'),
  '2027-06-12|Russia Day': june12Image,
  '2027-06-12|День России': june12Image,
  '2027-06-14|Day off for Russia Day': june12Image,
  '2027-06-14|Выходной за День России': june12Image,
  '2027-07-15|Democracy and National Unity Day': trJul15Image,
  '2027-07-15|Demokrasi ve Milli Birlik Günü': trJul15Image,
  '2027-07-19|Marine Day': require('../../../../assets/days_img/jp_20jul.webp'),
  '2027-07-19|海の日': require('../../../../assets/days_img/jp_20jul.webp'),
  '2027-08-11|Mountain Day': jpMountainDayImage,
  '2027-08-11|山の日': jpMountainDayImage,
  '2027-08-14|Birthday of Prophet Muhammad': require('../../../../assets/days_img/id_24aug.webp'),
  '2027-08-14|Maulid Nabi Muhammad SAW': require('../../../../assets/days_img/id_24aug.webp'),
  '2027-08-17|Independence Day of Indonesia': require('../../../../assets/days_img/id_17aug.webp'),
  '2027-08-17|Hari Kemerdekaan Republik Indonesia': require('../../../../assets/days_img/id_17aug.webp'),
  '2027-08-30|Victory Day': trAug30Image,
  '2027-08-30|Zafer Bayramı': trAug30Image,
  '2027-09-20|Respect for the Aged Day': require('../../../../assets/days_img/jp_21sep.webp'),
  '2027-09-20|敬老の日': require('../../../../assets/days_img/jp_21sep.webp'),
  '2027-09-23|Autumnal Equinox Day': require('../../../../assets/days_img/jp_23sep.webp'),
  '2027-09-23|秋分の日': require('../../../../assets/days_img/jp_23sep.webp'),
  '2027-10-11|Sports Day': require('../../../../assets/days_img/jp_12okt.webp'),
  '2027-10-11|スポーツの日': require('../../../../assets/days_img/jp_12okt.webp'),
  '2027-10-29|Republic Day': trOct29Image,
  '2027-10-29|Cumhuriyet Bayramı': trOct29Image,
  '2027-11-03|Culture Day': jpCultureDayImage,
  '2027-11-03|文化の日': jpCultureDayImage,
  '2027-11-04|National Unity Day': require('../../../../assets/days_img/ru_4nov.webp'),
  '2027-11-04|День народного единства': require('../../../../assets/days_img/ru_4nov.webp'),
  '2027-11-05|Day off for 2 January': newYearImage,
  '2027-11-05|Выходной за 2 января': newYearImage,
  '2027-11-23|Labor Thanksgiving Day': jpLaborThanksgivingDayImage,
  '2027-11-23|勤労感謝の日': jpLaborThanksgivingDayImage,
  '2027-12-25|Christmas Day': christmasImage,
  '2027-12-25|Hari Raya Natal': christmasImage,
  '2027-12-31|New Year holiday': newYearImage,
  '2027-12-31|Новогодний выходной': newYearImage,
  '2027-12-31|Year-end and New Year Holiday': newYearImage,
  '2027-12-31|年末年始休暇': newYearImage,
  '2027-01-05|Isra and Mi\'raj of Prophet Muhammad': require('../../../../assets/days_img/id_16jan.webp'),
  '2027-01-05|Isra Mi\'raj Nabi Muhammad SAW': require('../../../../assets/days_img/id_16jan.webp'),
  '2027-02-06|Chinese New Year 2578': require('../../../../assets/days_img/id_17feb.webp'),
  '2027-02-06|Tahun Baru Imlek 2578 Kongzili': require('../../../../assets/days_img/id_17feb.webp'),
};
