...
const WIDGET_IMAGE_BY_KEY: Record<string, string> = {
  ...
  '2027-01-01|Новый год': 'day_new_year_default',
  '2027-01-01|New Year\'s Day': 'day_new_year_default',
  '2027-01-01|元日': 'day_new_year_default',
  '2027-01-01|Yılbaşı Tatili': 'day_new_year_default',
  '2027-01-01|Tahun Baru Masehi': 'day_new_year_default',
  '2027-01-02|Новогодние каникулы': 'day_new_year_default',
  '2027-01-03|Новогодние каникулы': 'day_new_year_default',
  '2027-01-04|Новогодние каникулы': 'day_new_year_default',
  '2027-01-05|Новогодние каникулы': 'day_new_year_default',
  '2027-01-06|Новогодние каникулы': 'day_new_year_default',
  '2027-01-07|Рождество Христово': 'day_7jan_christmas',
  '2027-01-08|Новогодние каникулы': 'day_new_year_default',
  '2027-01-11|Coming of Age Day': 'day_jp_12jan',
  '2027-01-11|成人の日': 'day_jp_12jan',
  '2027-02-11|National Foundation Day': 'day_jp11_feb',
  '2027-02-11|建国記念の日': 'day_jp11_feb',
  '2027-02-22|Day off for 20 February': 'day_feb23_defender_day',
  '2027-02-22|Выходной за 20 февраля': 'day_feb23_defender_day',
  '2027-02-23|Defender of the Fatherland Day': 'day_feb23_defender_day',
  '2027-02-23|День защитника Отечества': 'day_feb23_defender_day',
  '2027-02-23|Emperor\'s Birthday': 'day_jp_23feb',
  '2027-02-23|天皇誕生日': 'day_jp_23feb',
  '2027-03-08|International Women\'s Day': 'day_mar8',
  '2027-03-08|Международный женский день': 'day_mar8',
  '2027-03-09|Eid al-Fitr (1st day)': 'day_tr_20match',
  '2027-03-09|Ramazan Bayramı (1. Gün)': 'day_tr_20match',
  '2027-03-09|Day of Silence, Saka New Year': 'day_id_18_24march',
  '2027-03-09|Hari Suci Nyepi Tahun Baru Saka 1949': 'day_id_18_24march',
  '2027-03-10|Eid al-Fitr (2nd day)': 'day_tr_20match',
  '2027-03-10|Ramazan Bayramı (2. Gün)': 'day_tr_20match',
  '2027-03-10|Eid al-Fitr 1448 H (Day 1)': 'day_id_18_24march',
  '2027-03-10|Hari Raya Idul Fitri 1448 H (Hari 1)': 'day_id_18_24march',
  '2027-03-11|Eid al-Fitr (3rd day)': 'day_tr_20match',
  '2027-03-11|Ramazan Bayramı (3. Gün)': 'day_tr_20match',
  '2027-03-11|Eid al-Fitr 1448 H (Day 2)': 'day_id_18_24march',
  '2027-03-11|Hari Raya Idul Fitri 1448 H (Hari 2)': 'day_id_18_24march',
  '2027-03-21|Vernal Equinox Day': 'day_jp_20mar',
  '2027-03-21|春分の日': 'day_jp_20mar',
  '2027-03-22|Compensatory Holiday': 'day_jp_20mar',
  '2027-03-22|振替休日': 'day_jp_20mar',
  '2027-03-26|Good Friday': 'day_id_3apr',
  '2027-03-26|Wafat Isa Al Masih': 'day_id_3apr',
  '2027-03-28|Easter Sunday': 'day_id_5apr',
  '2027-03-28|Paskah': 'day_id_5apr',
  '2027-04-23|National Sovereignty and Children\'s Day': 'day_tr_23apr',
  '2027-04-23|Ulusal Egemenlik ve Çocuk Bayramı': 'day_tr_23apr',
  '2027-04-29|Shōwa Day': 'day_jp_29apr',
  '2027-04-29|昭和の日': 'day_jp_29apr',
  '2027-05-01|Spring and Labor Day': 'day_may1',
  '2027-05-01|Праздник Весны и Труда': 'day_may1',
  '2027-05-01|Labour and Solidarity Day': 'day_may1',
  '2027-05-01|Emek ve Dayanışma Günü': 'day_may1',
  '2027-05-01|International Workers\' Day': 'day_may1',
  '2027-05-01|Hari Buruh Internasional': 'day_may1',
  '2027-05-03|Constitution Memorial Day': 'day_jp_3may',
  '2027-05-03|憲法記念日': 'day_jp_3may',
  '2027-05-03|Day off for Spring and Labor Day': 'day_may1',
  '2027-05-03|Выходной за Праздник Весны и Труда': 'day_may1',
  '2027-05-04|Greenery Day': 'day_jp_4may',
  '2027-05-04|みどりの日': 'day_jp_4may',
  '2027-05-05|Children\'s Day': 'day_jp_5may',
  '2027-05-05|こどもの日': 'day_jp_5may',
  '2027-05-06|Ascension of Jesus Christ': 'day_id_14may',
  '2027-05-06|Kenaikan Isa Al Masih': 'day_id_14may',
  '2027-05-09|Victory Day': 'day_ru_9may',
  '2027-05-09|День Победы': 'day_ru_9may',
  '2027-05-10|Day off for Victory Day': 'day_ru_9may',
  '2027-05-10|Выходной за День Победы': 'day_ru_9may',
  '2027-05-16|Eid al-Adha (1st day)': 'day_tr_kb',
  '2027-05-16|Kurban Bayramı (1. Gün)': 'day_tr_kb',
  '2027-05-16|Eid al-Adha 1448 H': 'day_id_27may',
  '2027-05-16|Hari Raya Idul Adha 1448 H': 'day_id_27may',
  '2027-05-17|Eid al-Adha (2nd day)': 'day_tr_kb',
  '2027-05-17|Kurban Bayramı (2. Gün)': 'day_tr_kb',
  '2027-05-18|Eid al-Adha (3rd day)': 'day_tr_kb',
  '2027-05-18|Kurban Bayramı (3. Gün)': 'day_tr_kb',
  '2027-05-19|Commemoration of Atatürk, Youth and Sports Day': 'day_tr_19may',
  '2027-05-19|Atatürk\'ü Anma, Gençlik ve Spor Bayramı': 'day_tr_19may',
  '2027-05-20|Vesak Day 2571 BE': 'day_id_31may',
  '2027-05-20|Hari Raya Waisak 2571 BE': 'day_id_31may',
  '2027-06-01|Pancasila Day': 'day_id_1jun',
  '2027-06-01|Hari Lahir Pancasila': 'day_id_1jun',
  '2027-06-06|Islamic New Year 1449 H': 'day_id_16jun',
  '2027-06-06|Tahun Baru Islam 1449 H': 'day_id_16jun',
  '2027-06-12|Russia Day': 'day_jun12_unity',
  '2027-06-12|День России': 'day_jun12_unity',
  '2027-06-14|Day off for Russia Day': 'day_jun12_unity',
  '2027-06-14|Выходной за День России': 'day_jun12_unity',
  '2027-07-15|Democracy and National Unity Day': 'day_tr_15jul',
  '2027-07-15|Demokrasi ve Milli Birlik Günü': 'day_tr_15jul',
  '2027-07-19|Marine Day': 'day_jp_20jul',
  '2027-07-19|海の日': 'day_jp_20jul',
  '2027-08-11|Mountain Day': 'day_jp_11aug',
  '2027-08-11|山の日': 'day_jp_11aug',
  '2027-08-14|Birthday of Prophet Muhammad': 'day_id_24aug',
  '2027-08-14|Maulid Nabi Muhammad SAW': 'day_id_24aug',
  '2027-08-17|Independence Day of Indonesia': 'day_id_17aug',
  '2027-08-17|Hari Kemerdekaan Republik Indonesia': 'day_id_17aug',
  '2027-08-30|Victory Day': 'day_tr_30aug',
  '2027-08-30|Zafer Bayramı': 'day_tr_30aug',
  '2027-09-20|Respect for the Aged Day': 'day_jp_21sep',
  '2027-09-20|敬老の日': 'day_jp_21sep',
  '2027-09-23|Autumnal Equinox Day': 'day_jp_23sep',
  '2027-09-23|秋分の日': 'day_jp_23sep',
  '2027-10-11|Sports Day': 'day_jp_12okt',
  '2027-10-11|スポーツの日': 'day_jp_12okt',
  '2027-10-29|Republic Day': 'day_tr_29okt',
  '2027-10-29|Cumhuriyet Bayramı': 'day_tr_29okt',
  '2027-11-03|Culture Day': 'day_jp_3now',
  '2027-11-03|文化の日': 'day_jp_3now',
  '2027-11-04|National Unity Day': 'day_ru_4nov',
  '2027-11-04|День народного единства': 'day_ru_4nov',
  '2027-11-05|Day off for 2 January': 'day_new_year_default',
  '2027-11-05|Выходной за 2 января': 'day_new_year_default',
  '2027-11-23|Labor Thanksgiving Day': 'day_jp_23now',
  '2027-11-23|勤労感謝の日': 'day_jp_23now',
  '2027-12-25|Christmas Day': 'day_7jan_christmas',
  '2027-12-25|Hari Raya Natal': 'day_7jan_christmas',
  '2027-12-31|New Year holiday': 'day_new_year_default',
  '2027-12-31|Новогодний выходной': 'day_new_year_default',
  '2027-12-31|Year-end and New Year Holiday': 'day_new_year_default',
  '2027-12-31|年末年始休暇': 'day_new_year_default',
  '2027-01-05|Isra and Mi\'raj of Prophet Muhammad': 'day_id_16jan',
  '2027-01-05|Isra Mi\'raj Nabi Muhammad SAW': 'day_id_16jan',
  '2027-02-06|Chinese New Year 2578': 'day_id_17feb',
  '2027-02-06|Tahun Baru Imlek 2578 Kongzili': 'day_id_17feb',
};
