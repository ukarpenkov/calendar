...
export const ruTranslations: Record<TranslationKey, string> = {
    ...
    'month.totals.totalDays': 'Дней',
    'month.totals.workingDays': 'Рабочие',
    'month.totals.nonWorkingDays': 'Выходные',
    ...
    'vacation.deleteConfirm': 'Удалить этот отпуск?',
    'vacation.empty': 'Отпусков пока нет. Нажмите + чтобы добавить.',
    'vacation.calendar': 'Календарь',
    'vacation.list': 'Список',
    'vacation.workDays': 'Рабочих дней',
    'vacation.totalDays': 'Всего дней',
    'vacation.preHolidayWarning': 'Предпраздничный: сокращён до 7ч',
