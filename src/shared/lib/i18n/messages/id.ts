...
export const idTranslations = {
  ...
  'settings.rows.bundledCalendar.title': 'Kalender produksi (2027)',
  ...
  'settings.rows.language.userImportHint':
    'Kalender dari impor JSON: mengganti bahasa antarmuka tidak mengganti data. Untuk kalender bawaan gunakan bagian «Kalender produksi (2027)» di bawah.',
  ...
  'vacation.save': 'Simpan',
  'vacation.delete': 'Hapus',
  'vacation.deleteConfirm': 'Hapus liburan ini?',
  'vacation.empty': 'Belum ada liburan. Ketuk + untuk menambah.',
  'vacation.calendar': 'Kalender',
  'vacation.list': 'Daftar',
  'vacation.workDays': 'Hari kerja',
  'vacation.totalDays': 'Total hari',
  'vacation.preHolidayWarning': 'Sebelum libur: hari kerja dipotong 7 jam',
  'vacation.legend.title': 'Legenda',
  'vacation.legend.workday': 'Hari kerja',
  'vacation.legend.weekend': 'Akhir pekan',
  'vacation.legend.holiday': 'Hari libur',
  'vacation.legend.shortened': 'Hari pendek',
  'vacation.legend.vacation': 'Liburan',
