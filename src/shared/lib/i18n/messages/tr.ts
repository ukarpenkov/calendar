...
export const trTranslations = {
  ...
  'vacation.color': 'Renk',
  'vacation.save': 'Kaydet',
  'vacation.delete': 'Sil',
  'vacation.deleteConfirm': 'Bu tatil silinsin mi?',
  'vacation.empty': 'Henüz tatil yok. Eklemek için + düğmesine dokunun.',
  'vacation.calendar': 'Takvim',
  'vacation.list': 'Liste',
  'vacation.workDays': 'İş günü',
  'vacation.totalDays': 'Toplam gün',
  'vacation.preHolidayWarning': 'Tatil öncesi: 7 saate kısaltıldı',
  'vacation.balance.title': 'Tatil bakiyesi',
  'vacation.balance.remaining': 'kalan',
  'vacation.balance.defaultTotal': '28',
  'vacation.legend.title': 'Gösterge',
  'vacation.legend.workday': 'İş günü',
  'vacation.legend.weekend': 'Hafta sonu',
  'vacation.legend.holiday': 'Resmi tatil',
  'vacation.legend.shortened': 'Kısa gün',
  'vacation.legend.vacation': 'Tatil',
