...
Цель: собрать в одном месте тему, импорт и служебную информацию.

Задачи:

- Построить экран настроек по структуре дизайна.
- Добавить блок текущего активного года.
- Добавить переключение light/dark theme.
- Добавить действие импорта JSON.
- Добавить служебный блок `About`.
...
- Построить экран настроек по макету.
- Показать текущий активный год.
- Добавить переключение light/dark theme.
- Добавить действие запуска импорта JSON.
- Показать служебный блок `About`.
